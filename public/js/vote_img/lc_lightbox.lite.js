...
(function ($) {
	...
	'<div id="lcl_wrap" class="lcl_pre_show lcl_pre_first_el lcl_first_sizing lcl_is_resizing">'+
		'<div id="lcl_window">'+
			...
			'<div id="lcl_nav_cmd">'+
				...
				'<div class="lcl_icon lcl_play" title="Play as slideshow"></div>'+
	...
	var lcl = function(obj, settings) {
		...
		var lcl_settings = $.extend({
			...
			socials			: false, // bool
			fb_direct_share	: true, // bool / whether to use direct FB contents share (requires APP ID to be specified)  
