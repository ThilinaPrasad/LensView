                ...
                <form method="POST" action="{{ route('contests.store') }}" enctype="multipart/form-data">
                    ...
                    <div id="sec_01">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="sub_start_at" type="date" class="form-control{{ $errors->has('sub_start_at') ? ' is-invalid' : '' }}" name="sub_start_at"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type='file' id='winner_img' type="text" class="form-control {{ $errors->has('winner_img') ? ' is-invalid' : '' }}"
                                    name="winner_img" value="{{ old('winner_img') }}"> @if ($errors->has('winner_img'))
                                <span class="invalid-feedback">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type='file' id='p_logo' type="text" class="form-control {{ $errors->has('p_logo') ? ' is-invalid' : '' }}"
                                    name="p_logo" value="{{ old('p_logo') }}"> @if ($errors->has('p_logo'))
                                <span class="invalid-feedback">
                         ...
                         <div class="form-group row">
                             ...
                             <div class="col-md-6">
                                 <input type='file' id='g_logo' type="text" class="form-control {{ $errors->has('g_logo') ? ' is-invalid' : '' }}"
                                     name="g_logo" value="{{ old('g_logo') }}"> @if ($errors->has('g_logo'))
                                 <span class="invalid-feedback">
                         ...
                         <div class="form-group row">
                             ...
                             <div class="col-md-6">
                                 <input type='file' id='b_logo' type="text" class="form-control {{ $errors->has('b_logo') ? ' is-invalid' : '' }}"
                                     name="b_logo" value="{{ old('b_logo') }}"> @if ($errors->has('b_logo'))
                                 <span class="invalid-feedback">
