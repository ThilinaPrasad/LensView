...
<div class="jumbotron text-center">
  ...
  <div class="container marketing" style="margin-top:50px;">
    <div class="row">
      <div class="col-lg-4">
        <img class="rounded-circle" src="{{ asset('img/vision.png') }}" alt="Generic placeholder image"
          width="140" height="140">
        <h2 style="font-weight:400;opacity:0.5;">VISION</h2>
      ...
      <div class="col-lg-4">
        <img class="rounded-circle" src="{{ asset('img/mission.png') }}" alt="Generic placeholder image"
          width="140" height="140">
        <h2 style="font-weight:400;opacity:0.5;">MISSION</h2>
      ...
      <div class="col-lg-4">
        <img class="rounded-circle" src="{{ asset('img/objective.png') }}" alt="Generic placeholder image"
          width="140" height="140">
        <h2 style="font-weight:400;opacity:0.5;">OBJECTIVE</h2>
