                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="telephone" type="tel" class="form-control{{ $errors->has('telephone') ? ' is-invalid' : '' }}" name="telephone" value="{{ old('telephone') }}">                                
                        ...
                        <div class="custom-control custom-checkbox form-group row">
                                ...
                                <input type="checkbox" class="custom-control-input {{ $errors->has('condition') ? ' is-invalid' : '' }}" id="customControlInline" name='condition' {{ old('condition') ? 'checked' : '' }}>
